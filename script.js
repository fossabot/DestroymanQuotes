...
// When the user clicks the image, play the audio
document.getElementById('destroyman-image').addEventListener('click', function() {
  playAudio();
});

// When the user clicks the image, display a new quote and play the audio
document.getElementById('destroyman-image').addEventListener('click', function() {
  displayRandomQuote();
  playAudio();
});
